...
<html lang="id">
   <head>
      ...
      <link rel="preconnect" href="https://racunproduk.files.wordpress.com">
      ...
      <script >if(!window._gtm_init){window._gtm_init=1;(function(w,n,d,m,e,p){w[d]=(w[d]==1||n[d]=='yes'||n[d]==1||n[m]==1||(w[e]&&w[e][p]&&w[e][p]()))?1:0})(window,navigator,'doNotTrack','msDoNotTrack','external','msTrackingProtectionEnabled');(function(w,d,s,l,x,y){w[x]={};w._gtm_inject=function(i){if(w.doNotTrack||w[x][i])return;w[x][i]=1;w[l]=w[l]||[];w[l].push({'gtm.start':new Date().getTime(),event:'gtm.js'});var f=d.getElementsByTagName(s)[0],j=d.createElement(s);j.async=true;j.src='https://www.googletagmanager.com/gtm.js?id='+i;f.parentNode.insertBefore(j,f);};w[y]('GTM-K5ZNMV4')})(window,document,'script','dataLayer','_gtm_ids','_gtm_inject')}</script>
      <meta name="description" content="${racun.excerpt.replace(/(<([^>]+)>)/ig, '')} Racun Shopee Irit.Link">
      <meta name="og:title" content="Racun ${merchant} ${racun.title} | Irit.Link by Sadiskon">
      ...
      <meta name="twitter:title"  content="Racun ${merchant} ${racun.title} | Irit.Link by Sadiskon">
      <meta name="twitter:description" content="${racun.excerpt.replace(/(<([^>]+)>)/ig, '')} Racun Shopee Irit.Link">
      ...
      <link rel="canonical" href="https://irit.link/p/${racun.slug}/">
      <script src="/assets/js/umbrella.js" defer></script>
            ...
            <div class="max-w-screen-sm mx-auto bg-white">
               <nav class="fixed z-5 top-0 left-0 w-full bg-white border-b-1">
                  <div class="max-w-screen-md mx-auto relative flex justify-between">
                     ...
                     <div class="rounded-full w-13 h-13 p-2"><img src="https://racunproduk.files.wordpress.com/2022/04/favicon.png?resize=32%2C32" width="32" height="32" alt="logo Sadiskon.com" class="w-full h-full rounded-full object-cover"></div>
               ...
               <div class="mt-12">
                  ...
                  <div id="social-modal_wrapper" class="fixed bg-opacity-0 max-h-0 transition-all ease-in-out duration-50 z-5 top-0 left-0 w-full bg-black">
                     ...
                     <div id="social-btns" class="-top-100 opacity-0 transition-all ease-in-out duration-400 relative block max-w-sm mx-auto p-5 bg-white rounded-br-2xl rounded-bl-2xl">
                        ...
                        <button class="racun-social_copylink flex w-full p-2 justify-center item-center gap-2 my-2 rounded-xl bg-gray-700" data-clipboard-text="Aku nemuin promo - ${racun.title} https://irit.link/${racun.slug}">
   ...
   function sharePopup(network) {
      var url = 'http://irit.link/p/${racun.slug}/'
