            ...
            <div class="max-w-screen-sm mx-auto bg-white">
               <nav class="fixed z-5 top-0 left-0 w-full bg-white border-b-1">
                  <div class="max-w-screen-md mx-auto relative flex justify-between">
                     ...
                     <div class="rounded-full w-13 h-13 p-2"><img src="https://racunproduk.files.wordpress.com/2022/04/iritlink.png?resize=32%2C32" width="32" height="32" alt="logo Sadiskon.com" class="w-full h-full rounded-full object-cover"></div>
